...
class BasicAVTransformerBlock(nn.Module):
    ...
    @staticmethod
    def _prompt_kv_modulation(params: mx.array | None, table: mx.array, dim: int) -> tuple[mx.array, mx.array]:
        ...
        ``params is None`` remains supported for an explicitly declared future
        architecture. Official LTX-2.3 and LTX-2.5 both supply prompt AdaLN.
        """
        if params is None:
